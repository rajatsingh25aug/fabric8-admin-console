...
@NgModule({
  ...
  providers: [
    ...
    { provide: AUTH_API_URL, useValue: environment.authUrl },
    { provide: SSO_API_URL, useValue: environment.ssoUrl },
    { provide: WIT_API_PROXY, useValue: environment.witUrl },
    { provide: ADMIN_API_URL, useValue: environment.adminUrl },
